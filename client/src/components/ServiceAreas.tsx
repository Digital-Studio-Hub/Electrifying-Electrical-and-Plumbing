...
const serviceAreas = [
  {
    ...
    areas: ["Durban CBD", "Point Waterfront", "Berea", "Greyville", "Morningside"]
  },
  {
    region: "North Durban",
    areas: ["Umhlanga", "Durban North", "La Lucia", "Mount Edgecombe", "Phoenix"]
  },
  {
    region: "South Durban",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-4">
            <MapPin className="h-8 w-8 text-primary" data-testid="icon-map-pin" />
            <h2 
          ...
          >
            Our expert electricians and plumbers provide fast, reliable service across Durban and surrounding areas. 
            No job too big or small. Call us for service in your area.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex flex-col sm:flex-row gap-4 items-center">
            <a href="tel:+27698055580" data-testid="link-call-service-areas">
              <button className="bg-primary text-primary-foreground px-8 py-4 rounded-md font-semibold text-lg hover-elevate active-elevate-2" data-testid="button-call-service-areas">
            ...
            >
              <button className="bg-secondary text-secondary-foreground px-8 py-4 rounded-md font-semibold text-lg hover-elevate active-elevate-2" data-testid="button-whatsapp-service-areas">
                WhatsApp for Quote
              </button>
            </a>
          </div>
